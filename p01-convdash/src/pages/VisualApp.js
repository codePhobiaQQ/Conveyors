...
export default class FullheightIframe extends Component {
    ...
    renderReactFrame() {
        return (
            <Iframe url="http://192.168.51.16/Pages/index2.php" width="100%" height="100%" onLoad={()=>{console.log("IFRAME ON LOAD")}}></Iframe>
        );
    }
    ...
    renderHTMLFrame() {
        return (
            <iframe
                ...
                ref="iframe"
                src="http://192.168.51.16/Pages/index2.php"
                width="100%"
                height="100%"
                scrolling="yes"
                frameBorder="0"
    ...
    render() {
        return (
            <div style={{maxWidth:2500, width:'100%', height:'100%', overflow:'auto'}}>
