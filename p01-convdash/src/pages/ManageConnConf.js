...
export default class FullheightIframe extends Component {
    ...
    renderReactFrame() {
        return (
            <Iframe title="Настройки соединений" url="http://192.168.51.17:8080/config" width="200%" height="100%" onLoad={()=>{console.log("IFRAME ON LOAD")}}></Iframe>
        );
    }
    ...
    renderHTMLFrame() {
        return (
            <iframe
                ...
                src="http://192.168.51.17:8080/config"
                width="100%"
                height="100%"
                scrolling="yes"
                frameBorder="0"
